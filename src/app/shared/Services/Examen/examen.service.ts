...
import { RegistroPacpExamenDTO, RegistroPacpExamenRespuestaDTO } from 'src/app/Models/ExamenDTO';
...
export class ExamenService {
  ...
  public Registrar(Json:RegistroPacpExamenDTO):Observable<any>{
  ...
  public RegistrarRespuestaSeleccion(Json:RegistroPacpExamenRespuestaDTO):Observable<any>{
  ...
  public ObtenerMejorExamenPorUsuario(Json:RegistroPacpExamenDTO):Observable<any>{
